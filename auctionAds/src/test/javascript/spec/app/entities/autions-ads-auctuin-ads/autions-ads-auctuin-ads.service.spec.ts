...
describe('Service Tests', () => {
    ...
    describe('AutionsAdsAuctuinAds Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AutionsAdsAuctuinAdsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/autions-ads';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AutionsAdsAuctuinAds', () => {
